...
namespace nesli_tukenmekte
{
    public partial class Listele : Form
    {
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                baglan.Open();
                string sorgu = "UPDATE hayvanlar SET ad =@ad, yasadigi_ulke=@yasadigi_ulke, populasyon=@populasyon, gorsel_ad=@gorsel_ad WHERE id = @satirid;";
        ...
        private void dgwCanli_SelectionChanged(object sender, EventArgs e)
        {
            ...
            {
               txtAdi.Text = dgwCanli.SelectedRows[0].Cells["adi"].Value.ToString();
        ...
        private void btnAra_Click(object sender, EventArgs e)
        {
            ...
            {
                baglan.Open();
                string sorgu = "SELECT * FROM hayvanlar ad LIKE @ara AND ;";
